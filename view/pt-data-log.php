                                ...
                                <thead>
                                  ...
                                  <tbody>
                                    <?php
                                     ...
                                     <?php
                                     if ($r['clear'] == 'N') {
                                       $icon= "<i class='ti ti-clipboard' title='belum masuk laporan'></i>";
                                       $delete ="<code class='code text-warning'><i class='ti-clipboard'></i> Pending</code>";

                                     }else {
                                       $icon= "<i class='ti ti-agenda'></i>";
                                       $delete ="<code class='text-success'><i class='icon-wallet'></i> Paid</code>";
                                     }
                                          echo "<tr>
