    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-image').click(function () {
            Swal.fire({
                ...
                imageUrl: "library/assets/images/users/2.jpg"
            });
        });
        ...
        $("#sa-bg").click(function () {
            Swal.fire({
                ...
                width: 600,
                padding: '3em',
                background: '#fff url(library/assets/images/background/active-bg.png)',
                backdrop: `
                        rgba(0,0,123,0.4)
                        url("library/assets/images/background/nyan-cat.gif")
                        center left
                        no-repeat
                    `
            })
